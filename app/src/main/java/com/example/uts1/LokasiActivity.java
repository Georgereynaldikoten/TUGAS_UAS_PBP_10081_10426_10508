...
public class LokasiActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(LokasiActivity.this, ProfilActivity.class));
            }
        });
    }
